...
local saveFile = "WataX_Key_antartika.txt"
...
local function isKeyValid(k)
    local url = "https://raw.githubusercontent.com/WataXScript/WataXAntartika157/main/Loader/eldl/"..k
...
if lastKey and isKeyValid(lastKey) then
    ...
    mainFrame.Visible = false
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataXAntartika157/main/Loader/WataX.lua"))()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataXAntartika157/main/Loader/mainmap792.lua"))()
end
